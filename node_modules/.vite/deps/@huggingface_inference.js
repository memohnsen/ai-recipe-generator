...
async function getDefaultTask(model, accessToken, options) {
  ...
  if (cachedTask === void 0) {
    const modelTask = await ((options == null ? void 0 : options.fetch) ?? fetch)(`${HF_HUB_URL}/api/models/${model}?expand[]=pipeline_tag`, {
...
async function chatCompletion(args, options) {
  ...
  const isValidOutput = typeof res === "object" && Array.isArray(res == null ? void 0 : res.choices) && typeof (res == null ? void 0 : res.created) === "number" && typeof (res == null ? void 0 : res.id) === "string" && typeof (res == null ? void 0 : res.model) === "string" && typeof (res == null ? void 0 : res.system_fingerprint) === "string" && typeof (res == null ? void 0 : res.usage) === "object";
  if (!isValidOutput) {
